...
// func (h *mockSentPacketHandler) ReceivedRecoveredFrame(frame *wire.RecoveredFrame, encLevel protocol.EncryptionLevel) error { panic("not implemented") }
...
// func (m *mockReceivedPacketHandler) GetRecoveredFrame() *wire.RecoveredFrame { panic("not implemented") }
// func (m *mockReceivedPacketHandler) SentRecoveredFrame(f *wire.RecoveredFrame) { panic("not implemented") }
