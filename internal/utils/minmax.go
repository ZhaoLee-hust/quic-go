...
// add by zhaolee
// MaxPacketNumber returns the max Symbol number
func MaxSymbolNumber(a, b protocol.SymbolNumber) protocol.SymbolNumber {
	if a > b {
		return a
	}
	return b
...
// MinPacketNumber returns the min Symbol number
func MinSymbolNumber(a, b protocol.SymbolNumber) protocol.SymbolNumber {
	if a < b {
		return a
	}
	return b
