...
// Front returns the first element of list l or nil. //ie return l.root.next
...
// Back returns the last element of list l or nil. //ie return l.root.prev
...
// PushFront inserts a new element e with value v at the front of list l and returns e. // ie l.insertValue(v, &l.root)
func (l *PacketList) PushFront(v Packet) *PacketElement {
	l.lazyInit()
	return l.insertValue(v, &l.root)
}

// PushBack inserts a new element e with value v at the back of list l and returns e. //ie l.insertValue(v, l.root.prev)
...
func (l *PacketList) MoveToFront(e *PacketElement) {
	...
	// see comment in PacketList.Remove about initialization of l
	l.insert(l.remove(e), &l.root) //这种写法很炫酷
}
